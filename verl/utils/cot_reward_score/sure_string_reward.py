...
def compute_score(solution_str, ground_truth, response_length, response_token_strs, method='strict', format_score=0.1, score=0.1, tokenizer=None, step=0, kick_in_steps=[20, 30, 40, 50]):
